            ...
            <div class="lg:col-span-5 bg-white p-8 rounded-3xl border border-gray-200 shadow-sm flex flex-col justify-between space-y-6">
                <div>
                    ...
                    <div class="space-y-5 text-sm">
                        ...
                        {{-- Jadwal PPDB --}}
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 rounded-xl bg-blue-50 text-blue-700 flex items-center justify-center flex-shrink-0 font-bold border border-blue-100">
                        ...
                        {{-- Biaya SPP --}}
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 rounded-xl bg-yellow-50 text-yellow-700 flex items-center justify-center flex-shrink-0 font-bold border border-yellow-100">
