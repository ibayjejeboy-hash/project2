...
<div class="min-h-screen bg-gradient-to-br from-green-50 via-lime-50/30 to-green-100/50 relative overflow-hidden flex flex-col justify-between">
    ...
    <main class="flex-1 flex flex-col items-center justify-center text-center px-6 py-16 max-w-5xl mx-auto z-10">
        ...
        <div class="flex gap-4 items-center">
            ...
            <a href="https://www.facebook.com/profile.php?id=100092545553574&locale=eo_EO#" class="bg-white p-3 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:scale-105 transition text-gray-500 hover:text-green-600">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>

            <a href="https://www.instagram.com/ra_almusyaffallah.real?utm_source=qr&igsh=YWlnY3E3Nng0cGRh" class="bg-white p-3 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:scale-105 transition text-gray-500 hover:text-pink-600">
            ...
            <a href="https://www.youtube.com/@raalmusyaffallah2496?app=desktop" class="bg-white p-3 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:scale-105 transition text-gray-500 hover:text-red-600">
